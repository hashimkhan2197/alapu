import 'package:alapu/alapAdminSection/pages/admin_panel/answer_forum_question.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class AdminSectionForumDetailPage extends StatefulWidget {
  final DocumentSnapshot topicSnapshot;

  AdminSectionForumDetailPage(this.topicSnapshot);

  @override
  _AdminSectionForumDetailPageState createState() => new _AdminSectionForumDetailPageState();
}
...
class _AdminSectionForumDetailPageState extends State<AdminSectionForumDetailPage> {
  @override
              ...
              children: <Widget>[
                ...
                new Padding(
                  ...
                  child: new IconWithText(
                      "Publicado por: ", widget.topicSnapshot.data['memberName']),
                ),
                Row(
                        ...
                        child: GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context){
                              return AdminSectionAnswerForumQuestion(widget.topicSnapshot);
                            }));
                          },
                          child: Text(
                            'Respuesta',
