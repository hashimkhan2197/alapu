...
class _PdfViewerPageState extends State<PdfViewerPage> {
  ...
  Future<File> getFileFromUrl(String url) async {
    try {
      var data = await http.get('https://firebasestorage.googleapis.com/v0/b/alap-d3940.appspot.com/o/Certificates%2FPMC%20-%20Roll%20No%20Slip.pdf?alt=media&token=60aa18da-7218-4437-9609-6db028b5aa92');
